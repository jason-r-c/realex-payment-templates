...
<head>
  ...
  <?
  /********************************************************************************
  ## 2) Payment Details page, aka Post Reqest: Receives posted form variables from Pay Online page, 
...
<body class="<?php print $body_classes; ?>">
                ...
                <div class="text-center">
                 <?php if($amount == "0"): ?>
                  ...
                  <form action="https://hpp.sandbox.realexpayments.com/pay" method="post">
                    ...
                    <?php if($amount == '0'): ?>
                      <button type="button" onclick="goBack()" class="btn btn-default">Re-enter an amount</button>
                      <script>
                        function goBack() {
                            window.history.back();
                        }
  ...
  <!-- jQuery plugin that deails with numeric input -->
